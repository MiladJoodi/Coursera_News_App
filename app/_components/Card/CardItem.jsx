...
const CardItem = ({ data }) => {
    return (
        <>
            <div className="grid grid-cols-4 border border-gray-200 rounded-md">
                <Image
                    src={data.image}
                    alt={data.title}
                ...
                <p className="col-span-full text-justify px-2 pr-6">{data.desc}</p>


                <button className="col-span-full bg-slate-100 flex p-3 my-2 gap-2 rounded-md mx-3 items-center justify-center text-md">
